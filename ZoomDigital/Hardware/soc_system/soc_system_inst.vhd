	component soc_system is
		port (
			...
			pio_load_external_connection_export               : in    std_logic_vector(7 downto 0)  := (others => 'X')  -- export
		);
	...
	u0 : component soc_system
		port map (
			...
			pio_load_external_connection_export               => CONNECTED_TO_pio_load_external_connection_export                --               pio_load_external_connection.export
		);
