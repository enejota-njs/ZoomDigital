...
//altsyncram CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Cyclone V" ENABLE_RUNTIME_MOD="YES" INSTANCE_NAME="RAM" NUMWORDS_A=256 OPERATION_MODE="SINGLE_PORT" OUTDATA_ACLR_A="CLEAR0" OUTDATA_REG_A="CLOCK0" POWER_UP_UNINITIALIZED="TRUE" read_during_write_mode_port_a="DONT_CARE" WIDTH_A=8 WIDTH_BYTEENA_A=1 WIDTHAD_A=8 aclr0 address_a clock0 data_a q_a rden_a wren_a
...
endmodule //memory__altsyncram1

//synthesis_resources = M10K 1 sld_mod_ram_rom 1 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  memory__altsyncram
	( 
	aclr0,
	address_a,
	clock0,
...
`endif
	...
	memory__altsyncram1   altsyncram1
	( 
	.aclr0(aclr0),
	.address_a(address_a),
...
`endif
	...
	memory__altsyncram	memory__altsyncram_component (
				.aclr0 (aclr),
				.address_a (address),
				.clock0 (clock),
				.data_a (data),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL memory_.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL memory_.inc FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL memory_.cmp FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL memory_.bsf FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL memory__inst.v FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL memory__bb.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL memory__syn.v TRUE
